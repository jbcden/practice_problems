# 1. Create a map of maximal { buy => sell }
# 2. For each day, calculate maximal total profits
# 3. Return max
def max_profit(prices)
  ...
  max_so_far = 0
  start_day = 0
  (start_day..final_day).each do |buy_day|
    (buy_day + 1..final_day).each do |sell_day|
      # puts "BUY DAY: #{buy_day}, MAX SO FAR: #{max_for_day}"
